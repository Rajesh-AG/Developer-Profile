  ...
  return (
    <div className="flex flex-wrap items-center gap-4 my-2">
      ...
      <Link 
        ...
        className="group relative inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#20E6A8] to-[#20C8E8] text-[#050606] font-bold text-[13px] tracking-[1px] uppercase rounded-lg cursor-pointer shadow-[0_4px_20px_rgba(32,230,168,0.25)] hover:shadow-[0_6px_30px_rgba(32,230,168,0.45)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 select-none"
      >
